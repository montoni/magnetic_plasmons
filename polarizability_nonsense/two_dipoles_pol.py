...
for r in range(1,30):
	...
	pol_vectors = [np.array([-1/math.sqrt(6),0]),np.array([-0.5/math.sqrt(6),-math.sqrt(3)/2/math.sqrt(6)]),np.array([0.5/math.sqrt(6),-math.sqrt(3)/2/math.sqrt(6)]),
		   		   np.array([1/math.sqrt(6),0]),np.array([0.5/math.sqrt(6),math.sqrt(3)/2/math.sqrt(6)]),np.array([-0.5/math.sqrt(6),math.sqrt(3)/2/math.sqrt(6)])]
