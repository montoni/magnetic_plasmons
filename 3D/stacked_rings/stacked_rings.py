...
for r in range(1,31):
	...
	Loc = [np.array([0,2*ey,0]),np.array([-ex,ey,0]),np.array([-ex,-ey,0]),np.array([0,-2*ey,0]),np.array([ex,-ey,0]),np.array([ex,ey,0]),
		   np.array([0,2*ey,ez]),np.array([-ex,ey,ez]),np.array([-ex,-ey,ez]),np.array([0,-2*ey,ez]),np.array([ex,-ey,ez]),np.array([ex,ey,ez])]
	'''x,y,z = zip(*Loc)
	fig = plt.figure()
