...
for epsb in range(1,2):
	...
	for r in range (10,301):
		...
		rij = 2.2*a0
		e = float(1)/float(2) * (2.2*a0) ; #short side of 30-60-90 triangle
		 #long side of 30-60-90 triangle
		Loc = [np.array([0,0]),np.array([e,0]),np.array([0,e]),np.array([e,e])]
