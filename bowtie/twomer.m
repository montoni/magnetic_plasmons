...
p1 = shift(rot(rod,30,[0,0,1]),[-sqrt(3)*dist/2,dist/2,0]);
p2 = shift(rot(rod,90,[0,0,1]),[-sqrt(3)*dist,0,0]);
p3 = shift(rot(rod,150,[0,0,1]),[-sqrt(3)*dist/2,-dist/2,0]);
p4 = shift(rot(rod,210,[0,0,1]),[sqrt(3)*dist/2,-dist/2,0]);
p5 = shift(rot(rod,270,[0,0,1]),[sqrt(3)*dist,0,0]);
p6 = shift(rot(rod,330,[0,0,1]),[sqrt(3)*dist/2,dist/2,0]);
Ptot= {p1,p2,p3,p4,p5,p6};
p=comparticle(epstab,Ptot,[2,1;2,1;2,1;2,1;2,1;2,1],1,2,3,4,5,6,op2);
exc = planewaveret( [ 0, 1, 0 ], [ 1, 0, 0 ] );
...
A(:,2) = ext;
A(:,3) = sca;
fid = fopen(strcat('rods_narrow_',num2str(rad),'nm'),'wt');                                                                                                                           for j = 1:length(enei)                                                                                                                                                               fprintf(fid,' %g', A(j,1));                                                                                                                                                fprintf(fid,' %g', A(j,2));                                                                                                                                                fprintf(fid,' %g', A(j,3));                                                                                                                                                fprintf(fid, '\n');                                                                                                                                              end                                                                                                                                                                        fclose(fid)                                                                                                                                                            end                              
