...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Fig. \ref{field_plots} displays two model oligomer systems, the 2-mer and 3-mer, comprising 10 and 13 silver nanospheres in analogy to the molecules naphthalene and phenalene. Mapping the electric plasmons of each nanoparticle onto harmonic oscillators is now well-understood \cite{ARPC} [CITE US], and forms the basis for modeling the collective magnetic plasmon responses. In the limit where each nanoparticle, here restricted to a spherical geometry of radius $a$, possesses only an electric dipole plasmon resonance, the equations of motion dictating the electromagnetic behavior of the oligomer are
\begin{equation}
...
\label{fourier_eom}
\end{equation}
It is this system of equations for the plasmon oscillator coordinates that we solve to determine the magnetic plasmon resonances. Considering two identical, coupled, collinear oscillators as an example, Eq. \ref{fourier_eom} becomes
\begin{equation}
\begin{split}
...
\label{eom_matrix}
\end{equation}
where $g_{12}=[HEY NICK!!!].$ Solution of this system produces the hybridized plasmon resonance frequencies and modes of the dimer. Specifically, they are
\begin{equation}
