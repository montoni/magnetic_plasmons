...
imp = [ex, ey+1.1*radius2; ex+1.1*radius2, ey; ex+(sqrt(3)*.5*1.1*radius2), ey+(.5*1.1*radius2)];

enei = eV2nm./linspace( 2,3,101);
ene = linspace(2,3,101);
...
fid = fopen([strcat('nm',num2str(num),'_2mer_CL_foba')],'wt');
