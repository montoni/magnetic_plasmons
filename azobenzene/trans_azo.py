...
if conformation == 'trans':
	Loc = [np.array([0,0,0]),np.array([-ex,ey,0]),np.array([-2*ex,0,0]),np.array([-2*ex,-2*ey,0]),
		   np.array([-3*ex,-3*ey,0]),np.array([-4*ex,-2*ey,0]),np.array([-4*ex,0,0]),np.array([-3*ex,ey,0]),
		   np.array([ex,ey,0]),np.array([ex,3*ey,0]),np.array([2*ex,4*ey,0]),
		   np.array([3*ex,3*ey,0]),np.array([3*ex,ey,0]),np.array([2*ex,0,0])]
elif conformation == 'cis':
	Loc = [np.array([4*ey,-2*ey,0]),np.array([3*ey,-2*ey,ey]),np.array([3*ey,-2*ey,-ey]),np.array([ey,-2*ey,ey]),
		   np.array([ey,-2*ey,-ey]),np.array([0,-2*ey,0]),np.array([-ex,-ey,0]),np.array([-ex,ey,0]),
		   np.array([4*ey,2*ey,0]),np.array([3*ey,2*ey,ey]),np.array([3*ey,2*ey,-ey]),np.array([ey,2*ey,ey]),
		   np.array([ey,2*ey,-ey]),np.array([0,2*ey,0])]
'''x,y,z = zip(*Loc)
fig = plt.figure()
...
ax = fig.gca(projection='3d')
ax.scatter(x,y,z)
ax.quiver(x,y,z,u,v,w,length=rij)
plt.show()
